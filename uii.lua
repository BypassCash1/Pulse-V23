...
function Library:Create(table)
    ...
    function tabHandler:Tab(name)
        ...
        function ElementHandler:Dropdown(text, list, callback)
            ...
            textLabel7.TextColor3 = Color3.fromRGB(195, 195, 195)
            textLabel7.TextSize = 13
            textLabel7.TextStrokeColor3 = Color3.fromRGB(195, 195, 195)
            textLabel7.TextXAlignment = Enum.TextXAlignment.Left
            textLabel7.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            textLabel7.BackgroundTransparency = 1
            textLabel7.Position = UDim2.fromScale(0.0181, 0)
            textLabel7.Size = UDim2.fromOffset(1, 32)
            ...
            selectedLabel.Position = UDim2.fromScale(0.75, 0)
            selectedLabel.Size = UDim2.fromOffset(100, 32)
            selectedLabel.Parent = dropdown

            local dropdownIcon = Instance.new("ImageLabel")
            dropdownIcon.Name = "dropdownIcon"
            dropdownIcon.Image = "rbxassetid://3926305904"
            dropdownIcon.ImageColor3 = Color3.fromRGB(195, 195, 195)
            dropdownIcon.Rotation = 0
            dropdownIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            dropdownIcon.BackgroundTransparency = 1
            dropdownIcon.Position = UDim2.fromScale(0.943, 0.25)
            ...
            dropdownList.Size = UDim2.fromOffset(441, 0)
            dropdownList.ClipsDescendants = true
            dropdownList.Visible = false

            local uICorner16 = Instance.new("UICorner")
            uICorner16.Name = "uICorner16"
            uICorner16.CornerRadius = UDim.new(0, 6)
            uICorner16.Parent = dropdownList
            ...
            for _, option in ipairs(list) do
                ...
                optionButton.Size = UDim2.fromOffset(435, 25)
                ...
                optionButton.MouseLeave:Connect(function()
                    TweenService:Create(optionButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(38, 38, 38)}):Play()
                end)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(dropdownList, TweenInfo.new(0.3), {Size = UDim2.fromOffset(441, 0)}):Play()
                    wait(0.3)
                    dropdownList.Visible = false
                end)
            end
            ...
            dropdown.MouseEnter:Connect(function()
                TweenService:Create(dropdown, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(43,43,43)}):Play()
            end)

            dropdown.MouseLeave:Connect(function()
                TweenService:Create(dropdown, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(38,38,38)}):Play()
            end)
            ...
            dropdown.MouseButton1Click:Connect(function()
                ...
                if opened then
                    ...
                    local listHeight = (#list * 27) + 6
                    TweenService:Create(dropdownIcon, TweenInfo.new(0.2), {Rotation = 180}):Play()
                    TweenService:Create(dropdownList, TweenInfo.new(0.3), {Size = UDim2.fromOffset(441, listHeight)}):Play()
                else
                    TweenService:Create(dropdownIcon, TweenInfo.new(0.2), {Rotation = 0}):Play()
                    TweenService:Create(dropdownList, TweenInfo.new(0.3), {Size = UDim2.fromOffset(441, 0)}):Play()
                    wait(0.3)
        ...
        function ElementHandler:Interactable(text, actionText, callback)
            text = text or "Interactable"
            actionText = actionText or "Execute"
            callback = callback or function() end

            local interactable = Instance.new("TextButton")
            interactable.Name = "interactable"
            interactable.BackgroundColor3 = Color3.fromRGB(38, 38, 38)
            interactable.Size = UDim2.fromOffset(441, 32)
            interactable.Text = ""
            ...
            uICorner17.Parent = interactable

            local textLabel8 = Instance.new("TextLabel")
            textLabel8.Name = "textLabel8"
            textLabel8.Font = Enum.Font.Gotham
            textLabel8.Text = text
            textLabel8.TextColor3 = Color3.fromRGB(195, 195, 195)
            textLabel8.TextSize = 13
            textLabel8.TextStrokeColor3 = Color3.fromRGB(195, 195, 195)
            textLabel8.TextXAlignment = Enum.TextXAlignment.Left
            textLabel8.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            textLabel8.BackgroundTransparency = 1
            textLabel8.Position = UDim2.fromScale(0.0181, 0)
            textLabel8.Size = UDim2.fromOffset(1, 32)
            textLabel8.Parent = interactable
            ...
            actionButton.BackgroundColor3 = Color3.fromRGB(58, 58, 58)
            actionButton.Position = UDim2.fromScale(0.82, 0.19)
            actionButton.Size = UDim2.fromOffset(70, 20)
            ...
            actionButton.Parent = interactable
            interactable.Parent = holder

            interactable.MouseEnter:Connect(function()
                TweenService:Create(interactable, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(43,43,43)}):Play()
            end)

            interactable.MouseLeave:Connect(function()
                TweenService:Create(interactable, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(38,38,38)}):Play()
            end)

            actionButton.MouseEnter:Connect(function()
                TweenService:Create(actionButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(68,68,68)}):Play()
            end)

            actionButton.MouseLeave:Connect(function()
                TweenService:Create(actionButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(58,58,58)}):Play()
            end)

            actionButton.MouseButton1Click:Connect(function()
                TweenService:Create(actionButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(48,48,48)}):Play()
                wait(0.1)
                TweenService:Create(actionButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(58,58,58)}):Play()
                callback()
            end)
        end
